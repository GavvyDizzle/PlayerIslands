...
public class PasteSizeUpgradeSchematic extends SubCommand implements PermissionCommand {
    ...
    public void perform(CommandSender sender, String[] args) {
        ...
        PlayerIslands.getInstance().getUpgradeManager().pasteSchematic(((Player) sender).getLocation(), PlayerIslands.getInstance().getUpgradeManager().getSizeUpgrade(level-1), sizeUpgrade);
